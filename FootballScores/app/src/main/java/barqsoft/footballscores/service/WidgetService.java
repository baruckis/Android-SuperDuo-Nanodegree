...
class StackRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        ...
        date[0] = Utilies.getFragmentDate(mContext, 0);
    ...
    public RemoteViews getViewAt(int position) {
        ...
        view.setImageViewResource(R.id.home_crest, Utilies.getTeamCrestByTeamName(mContext, data.getString(COL_HOME)));
        view.setImageViewResource(R.id.away_crest, Utilies.getTeamCrestByTeamName(mContext, data.getString(COL_AWAY)));
